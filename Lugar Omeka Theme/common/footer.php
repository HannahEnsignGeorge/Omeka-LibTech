	...
	<div class="column-left-footer footerleft">
	   ...
	   <a href="https://libraries.indiana.edu" class="footerlib-icon">
		<?php echo $this->shortcodes('[anyfile id="IU Libraries Fully Reversed Horizontal Lockup.png" img=true width="200px"]'); ?>
	   </a>
	   </li>
	   ...
	   <li id="footer-arch" style="float:left;"><a href="https://libraries.indiana.edu/archives" >University Archives Home</a>
	   </li>
