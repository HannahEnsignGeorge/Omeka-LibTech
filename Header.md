...
<head>
  ...
  queue_js_file('vendor/selectivizr', 'javascripts', array('contditional' => '(gte IE 6)&(lte IE 8)'));
  queue_js_file('vendor/respond');
  queue_js_file('globals');
  echo head_js();
  ?>
  <!-- Piwik --> (!!Added to Thanks, Roy header.php!!)
  <script type="text/javascript">
   ...
   <?php echo body_tag(array('id' => @$bodyid, 'class' => @$bodyclass)); ?>
    <?php fire_plugin_hook('public_body', array('view'=>$this)); ?>
      ...
      <header>
        <?php fire_plugin_hook('plugin_header', array('view'=>$this)); ?>
